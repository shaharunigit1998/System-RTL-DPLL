...
2.Firstly run Looptb.vs to see that our Loop module is logically equivalent to the MATLAB DPLL.
...
4.Run The MATLAB simulation at MAIN and see that the Phase Noises Look the Same!
